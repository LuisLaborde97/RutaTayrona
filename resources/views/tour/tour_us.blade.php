  ...
  <div class="row">
      <div class="col-lg-7" style="margin-top: 4%;">
          ...
          <article>
              ...
              <header class="mb-4">
                  <!-- Post title-->
                  <h1 class="fw-bolder mb-2">{{$tour[0]->nombre_producto}}</h1><sup><h4>(Book now for 30%)</h4></sup>
                  <!-- Post meta content-->
                  <!-- Post categories-->
              </header>
            ...
            <div class="row row-50 justify-content-center align-items-xl-center">
                ...
                <div class="tabs-custom tabs-horizontal tabs-line" id="tabs-4">
                  ...
                  <ul class="nav nav-tabs">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="#tabs-4-1" data-toggle="tab">Itinerary</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-4-2" data-toggle="tab">Includes</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-4-3" data-toggle="tab">Recommendations and Tips</a></li>
                  </ul>
                  <!-- Tab panes-->
                           ...
                           <div class="card-body">
                            <h4 class="card-title">Tips</h4>
                             ...
                             <div class="card-footer">
                               <h4>ENJOY THIS EXPERIENCE TO THE FULLEST</h4>
                             </div>
                           </div>
...
<div class="card">
  <div class="card-header"><h5 class="card-title">Complete the purchase</h5></div>
  ...
  <div class="card-body">
    <form id="clientes2">
      <div class="row">
          ...
          <div class="col-lg-10">
            <div class="mb-3">
              <input type="text" class="form-control" name="personas" id="personas" placeholder="Companions">
            </div>
          </div>
        ...
        <button type="button" id="reserva" class="btn btn-outline-success" data-bs-toggle="modal" >Continue</button>
        ...
        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <h5 class="modal-title" id="staticBackdropLabel">Payment of the remaining 70% is to be completed at the following offices</h5>
                 ...
                 <div class="card-header"><h5 class="card-title">Complete the purchase</h5></div>
                   <div class="card-body">
                      ...
                      <form id="clientes" name="clientes">
                        ...
                        <div class="col-lg-4">
                          <div class="mb-3">
                            <input type="number" class="form-control" name="edad" id="edad" placeholder="Age">
                          </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                          <div class="mb-3">
                            <input class="form-control" type="text" name="indicativo" id="indicativo" placeholder="+1">
                          </div>
                        </div>

                        <div class="col-lg-5">
                          <div class="mb-3">
                            <input class="form-control" type="text" name="telefono" id="telefono" placeholder="Phone">
                          </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                          <div class="mb-3">
                            <select class="form-select" name="identificacion" id="identificacion">
                              <option selected>Type of Identification</option>
                        ...
                        <div class="col-lg-6">
                          <div class="mb-3">
                            <input class="form-control" type="text" name="num_identificacion" id="num_identificacion" placeholder="Identification">
                          </div>
                        </div>

                        <div class="col-lg-12">
                          <div class="mb-3">
                            <textarea class="form-control" name="salida" id="salida" placeholder="Departure place"></textarea>
                          </div>
                        </div>

                        <div class="col-lg-12">
                          <div class="mb-3">
                            <textarea class="form-control" name="recomendacion" id="recomendacion" placeholder="Recommendations"></textarea>
                          </div>
                        </div>
                        ...
                        <div class="card-footer">
                          <div class="mb-3">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="{{number_format($item->precio,2)}}" id="checkAdicional" name="check" ">
                          ...
                          <div class="col-lg-12">
                            <div class="mb-3">
                             <h4>Precio: <span id="precio">{{number_format($tour[0]->precio_base*0.3, 2)}}</span> </h4>
                            </div>
                          </div>
                          ...
                          <button type="button" id="finalizar" class="btn btn-outline-success">Buy</button>
            ...
            <div class="modal fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-50" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title text-center text-muted" id="total"> Total payable: {{number_format($tour[0]->precio_base*0.3, 2)}}</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      <div class="mb-3">
